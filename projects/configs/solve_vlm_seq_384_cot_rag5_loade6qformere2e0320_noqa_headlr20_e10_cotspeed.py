...
file_name = 'solve_vlm_seq_384_cot_rag5_loade6qformere2e0320_noqa_headlr20_e10_cotspeed'
...
model = dict(
    ...
    e2e_head=dict(
        ...
        kmeans_anchor_path='ckpts/solve_kmeans_plan_6.npy',
        # pretrained_path='./work_dirs/mask_eva_lane_det_vlm_cons_onlyreg_b48e20_lr3e4/latest.pth',
        ),
...
train_pipeline = [
    ...
    dict(type='LoadAnnoatationVQATraj', 
...
test_pipeline = [
    ...
    dict(type='NormalizeMultiviewImage', **img_norm_cfg),
    dict(type='PadMultiViewImage', size_divisor=32),
    dict(type='LoadAnnoatationVQATestSOLVE', 
