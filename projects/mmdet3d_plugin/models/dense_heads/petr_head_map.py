...
class PETRHeadM(AnchorFreeHead):
    ...
    def forward(self, img_metas, pos_embed, **data):
        ...
        #1800, 256; 11, 256 -> torch.Size([1800, 11, 256])
        lane_embedding = self.instance_embedding_lane.weight.unsqueeze(-2) + self.points_embedding_lane.weight.unsqueeze(0) # Embedding(1800, 256)+Embedding(11, 256)
        ...
        lane_queries = outs_dec # torch.Size([6, 2, 1800, 256])
        outputs_lane_preds = []
        outputs_lane_clses = []
